...
--
-- Host: localhost
-- Generation Time: Dec 01, 2023 at 12:22 PM
...
INSERT INTO `categories` (`uid`, `name`, `descr`, `status`, `addedDate`, `lastUpdate`, `addedBy`) VALUES
(1, 'Web Development', 'covering all aspects of web development such as front-end, back-end, full-stack, frameworks, librari', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(2, 'SEO', 'covering topics related to search engine optimization, such as keyword research, on-page optimizatio', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(3, 'Digital Marketing', 'covering various digital marketing channels such as email marketing, social media marketing, PPC adv', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(4, 'Website Design', 'covering topics related to website design such as UI/UX design, responsive design, typography, color', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(5, 'E-commerce', 'covering topics related to e-commerce websites such as payment gateways, shopping carts, product cat', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(6, 'Mobile Optimization', 'covering topics related to mobile optimization such as responsive design, mobile apps, mobile SEO, a', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(7, 'Analytics', 'covering topics related to web analytics such as Google Analytics, data visualization, A/B testing, ', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(8, 'Security', 'covering topics related to website security such as SSL, secure coding practices, hacking prevention', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(9, 'Performance', 'covering topics related to website performance optimization such as website speed, caching, compress', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(10, 'Content Marketing', 'covering topics related to content marketing such as content creation, promotion, distribution, and ', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(11, 'Social Media Marketing', 'covering topics related to social media marketing such as social media platforms, social media adver', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(12, 'Branding', 'covering topics related to branding such as brand identity, brand strategy, brand messaging, and mor', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(13, 'User Experience', 'covering topics related to user experience such as user research, usability testing, user journey ma', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(14, 'Web Technologies', 'covering various web technologies such as HTML, CSS, JavaScript, PHP, MySQL, and more.', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(15, 'Accessibility', 'covering topics related to web accessibility such as ADA compliance, WCAG guidelines, assistive tech', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1),
(16, 'Standards', 'covering topics related to web standards such as W3C, HTML5, CSS3, and more.', 1, '2023-04-07 22:06:17', '0000-00-00 00:00:00', 1);
...
INSERT INTO `posts` (`uid`, `title`, `content`, `author`, `publishedDate`, `addedBy`, `categoryId`, `status`, `addedDate`, `lastUpdate`) VALUES
...
CREATE TABLE `post_img` (
  ...
  `imgPath` varchar(80) NOT NULL DEFAULT 'uploads/posts/',
...
INSERT INTO `post_views` (`uid`, `postId`, `viewCount`, `lastViewed`) VALUES
...
INSERT INTO `roles` (`uid`, `name`, `status`, `addedDate`, `lastUpdate`, `addedBy`) VALUES
(1, 'Super Admin', 1, '2023-04-07 17:32:36', '0000-00-00 00:00:00', 0),
(2, 'Admin', 1, '2023-04-07 17:32:36', '0000-00-00 00:00:00', 0),
(3, 'Editor', 1, '2023-04-07 17:32:54', '0000-00-00 00:00:00', 0);
...
INSERT INTO `users` (`uid`, `name`, `username`, `email`, `password`, `role`, `status`, `addedDate`, `lastUpdate`, `addedBy`) VALUES
(1, NULL, 'sntaks', 'info@sntaks.com', 'Asdf@123', 1, 1, '2023-04-07 19:09:16', '0000-00-00 00:00:00', 0),
(2, NULL, 'wizard', 'vincentkioko51@gmail.com', 'Asdf@123', 3, 1, '2023-04-07 19:09:17', '0000-00-00 00:00:00', 0);
